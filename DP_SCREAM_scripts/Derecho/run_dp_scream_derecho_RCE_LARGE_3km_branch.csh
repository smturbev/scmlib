#!/bin/tcsh
#PBS -N zL_branch_a_lsascent300k_wbranch
#PBS -A UWAS0108
...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename dpscream_rce_large_3km_a_lsascent300k_wbranch
  
  # Set the case name of the branch here if applicable
  set branch_case = dpscream_rce_large_3km_lsascent300k_branch
  ...
  setenv job_priority economy # not used, hard-coded below
  ...
  set domain_size_x = 5120000 #120000
  set domain_size_y = 320000 #120000
...
# Define executable and run directories
  ...
  ./xmlchange --id JOB_PRIORITY --val "economy"
