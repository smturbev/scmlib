#!/bin/tcsh
#PBS -N zDPSCREAM_SMALL_test_wnuc
#PBS -A UWAS0108
...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename scream_dp_RCE_SMALL_3km_test_wnuc #dpscream_rce_small_3km_aa_default
  set branch_case="scream_dp_RCE_SMALL_3km_test_branch_ba"
  set branch_date="2000-01-12"
...
# For a branched run, input the reference directory here
 ./xmlchange RUN_TYPE="branch",RUN_REFCASE=$branch_case,RUN_REFDATE=$branch_date,RUN_REFDIR="/glade/derecho/scratch/sturbeville/DPSCREAM_simulations/${branch_case}/run/"
