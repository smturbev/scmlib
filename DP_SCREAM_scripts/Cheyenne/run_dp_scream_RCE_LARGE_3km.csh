...
#######  BEGIN USER DEFINED SETTINGS
  ...
  #   I change something.
  setenv casename scream_dp_RCE_LARGE_3km_aa
  # aa = default (do_new_lp_freezing=false,sed_scaling=1,dep_scaling=1,do_subsidence=true)
  ...
  set num_ne_x = 48 # = 12*4 = 48*3*3.33 = 480km
  set num_ne_y = 48
