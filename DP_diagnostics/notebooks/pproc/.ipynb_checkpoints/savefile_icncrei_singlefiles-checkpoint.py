...
for s, sim in enumerate(simul): #fake loop!!!!!
    ...
    data_3d = sam.ncopen(path+'walker_1cat_3840x384_1x1km_100m_dc_192.bin2D_1.nc',varnames3d,ind=timeind)
    datap = sam.ncopen(path+'walker_1cat_3840x384_1x1km_100m_dc_192.bin2D_1.nc',varp) #pressure always the same, I think
...
if (write == 1):
    ...
    ncfile = NetCDFFile(savepath+'ICNCvsREI_Walker3D_1km_z100m_qi1e-5_Tless-40.nc', 'w',  format='NETCDF4_CLASSIC') 
