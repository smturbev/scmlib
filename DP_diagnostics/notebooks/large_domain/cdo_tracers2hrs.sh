...
cdo -seltimestep,-41/-1 -selvar,NUC,BCU,W_NUC,NI_NUC,IWC,CLDICE,CLDLIQ,NUMICE,T,OMEGA,Q,Z3,QRS,QRL,TMQ,TGCLDIWP,TGCLDLWP,LWCF,SWCF,crm_grid_x,crm_grid_y $ds_file $ds5day_file
