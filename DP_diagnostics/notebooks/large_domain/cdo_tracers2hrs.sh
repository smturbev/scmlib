...
run=lpls300k_no_max_total_ni_a
...
cdo -selvar,NUC,BCU,W_NUC,NI_NUC,IWC,CLDICE,CLDLIQ,T,OMEGA,Q,Z3,QRS,QRL,TGCLDIWP,TGCLDLWP,LWCF,SWCF,crm_grid_x,crm_grid_y $ds_file $ds5day_file
