...
"plot_insitu_nuc_iwc.py" 89L, 3223B                                                                                     1,1           Top
#!/home/disk/p/smturbev/miniconda3/envs/dyamond/bin/python
...
ins_ci = np.where((bcu_ds>24)&(nuc_ds<bcu_ds-5), nuc_ds, np.nan)
n_ins = np.nansum((bcu_ds>24)&(nuc_ds<bcu_ds-5))
print(n_ins, 'total insitu cirrus grid points')

bins = np.arange(0,48)
bin_mids = (bins[1:]+bins[:-1])/2
ybins = np.logspace(-6,-1,21)
ybin_mids = (ybins[1:]+ybins[:-1])/2
print('Flatten arrays for binned statistic: IWC and insitu NUC...')
ins_ci_flat = ins_ci.flatten()
print('... cont...')
DP_diagnostics	   E3SM_SCM_scripts  README.md
DP_SCREAM_scripts  LICENSE	     SCM_diagnostics
olympus:/home/olympus5/smturbev/scmlib> cd DP
DP_diagnostics/    DP_SCREAM_scripts/
olympus:/home/olympus5/smturbev/scmlib> cd DP_diagnostics/
olympus:/home/olympus5/smturbev/scmlib/DP_diagnostics> cd notebooks/
olympus:/home/olympus5/smturbev/scmlib/DP_diagnostics/notebooks> ls
large_domain  plots  pproc  small_domain  stats
olympus:/home/olympus5/smturbev/scmlib/DP_diagnostics/notebooks> cd large_domain/
olympus:/home/olympus5/smturbev/scmlib/DP_diagnostics/notebooks/large_domain> ls -t
plot_insitu_nuc_iwc.py
plot_tracers_cdf.py
iwc-t-param-spcae.ipynb
plots_large.ipynb
micro_p3_hist-large.ipynb
plot_ams25.ipynb
e1534.out
o1534.out
cdo_tracers2hrs.sh
plot_column_ins_nuc_iwp.py
e1533.out
o1533.out
e1532.out
o1532.out
...
tracers_test.ipynb
util.py
mhist_count_def300k_days5-10.nc
#!/home/disk/p/smturbev/miniconda3/envs/dyamond/bin/python
...
ice_ds = xr.open_dataset(ice_file, chunks=chunks).IWC.isel(time=slice(-nt,-1))
# print('... W_NUC...')
"plot_tracers_cdf.py" 107L, 3787B                                                                                       1,1           Top
#!/home/disk/p/smturbev/miniconda3/envs/dyamond/bin/python
